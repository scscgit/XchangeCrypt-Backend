    ...
    public class WalletOperationService
    {
        ...
        public string GetLastPublicKey(string user, string accountId, string coinSymbol)
        {
            var hotWallet = HotWallets.Find(hotWalletEntry =>
                    ...
                    && hotWalletEntry.CreatedOnVersionNumber != 0)
...
//        }
        ...
        public void HideWalletsAfterVersionNumber(long currentVersion)
        {
            // Hides all wallets generated by a previous run
            HotWallets.UpdateMany(
                Builders<HotWallet>.Filter.Gt(e => e.CreatedOnVersionNumber, currentVersion),
                Builders<HotWallet>.Update.Set(e => e.CreatedOnVersionNumber, 0));
        }
    }
}
